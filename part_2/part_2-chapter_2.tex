...
%    		\draw[help lines] (-6,-3) grid (6,3);
    		\node (picture) at (0,0) {\includegraphics{figures/part_2_chapter_2/mink_sum}};
    		\node (A) at (-5, -0.5) {$S_1$};
...
%    		\draw[help lines] (-2,-2) grid (2,2);
    		\node (picture) at (0,0) {\includegraphics{figures/part_2_chapter_2/intersection.pdf}};
    		\node (A) at (-1, -0.15) {$S_1$};
...
Hyperplanes and halfspaces will play a central role in the developments we will see in our course. Therefore, let us take a moment and discuss some important aspects related these convex sets. First, notice that, geometrically, a hyperplane $H \subset \reals^n$ can be interpreted as the set of points with a \emph{constant} inner product to a given vector $p \in \reals^n$, while $\overline{x}$ determines the offset of the hyperplane from the origin. That is,
	...
	\begin{figure}[H]
	    \begin{tikzpicture}
%    		\draw[help lines] (-2,-2) grid (2,2);
    		\node (picture) at (0,0) {\includegraphics{figures/part_2_chapter_2/hyperplane.pdf}};
    		\node (p) at (-1.3, 0.8) {$p$};
	...
	Analogously, a halfspaces can be represented as $S = \braces{x \in \reals^n : p^\top(x - \overline{x}) \le 0}$ where $p^\top \overline{x} = \alpha$ is the hyperplane that forms the boundary of the halfspace. This definition suggests a simple geometrical interpretation: the halfspace $S$ consists of $\overline{x}$ plus any vector with an obtuse or right angle (i.e., greater of equal to 90$^\circ$) with the outward normal vector $p$.
 	...
 	\begin{figure}[H]
	    \begin{tikzpicture}
%    		\draw[help lines] (-2,-2) grid (2,2);
    		\node (picture) at (0,0) {\includegraphics{figures/part_2_chapter_2/halfspace.pdf}};
    		\node (p) at (-1.3, 0.75) {$p$};
    ...
    \begin{tikzpicture}
%    		\draw[help lines] (-2,-2) grid (2,2);
    		\node (picture) at (0,0) {\includegraphics{figures/part_2_chapter_2/polyhedral_set.pdf}};
...
%    		\draw[help lines] (-3,-2) grid (3,2);
    		\node (picture) at (0,0) {\includegraphics{figures/part_2_chapter_2/convex_hull.pdf}};
    		\node (A) at (-1.5, 0) {$S$};
...
%    		\draw[help lines] (-6,-1) grid (6,1);
    		\node (picture) at (0,0) {\includegraphics{figures/part_2_chapter_2/Weierstrass.pdf}};
...
\begin{figure}[h]
	\begin{tikzpicture}
%    	\draw[help lines] (-3,-2) grid (3,2);
		\node (picture) at (0,0) {\includegraphics{figures/part_2_chapter_2/closest_point.pdf}};
		\node (y1) at (-2.8, 2) {$y$};
		\node (y2) at (4, 0.8) {$y$};
...
%	\includegraphics[scale=0.6]{Figures/hyperplanes.pdf}
	\begin{tikzpicture}
%    	\draw[help lines] (-2,-2) grid (2,2);
		\node (picture) at (0,0) {\includegraphics{figures/part_2_chapter_2/halfspaces.pdf}};
		\node (p) at (-1.4, 0.8) {$p$};
...
%    	\draw[help lines] (-4,-2) grid (4,2);
		\node (picture) at (0,0) {\includegraphics{figures/part_2_chapter_2/separations.pdf}};
...
%    	\draw[help lines] (-5,-2) grid (5,2);
		\node (picture) at (0,0) {\includegraphics{figures/part_2_chapter_2/farkas.pdf}};
...
%    	\draw[help lines] (-6,-2) grid (6,2);
		\node (picture) at (0,0) {\includegraphics{figures/part_2_chapter_2/support_hyperplane.pdf}};
		\node (S1) at (-4.3,-0.5) {$S$};
		\node (S2) at (-1,-0.5) {$S$};
		\node (S3) at (2.5,-0.5) {$S$};
...
%	\includegraphics[width=0.3\textwidth]{Figures/support_convex.pdf}
	\begin{tikzpicture}
%    	\draw[help lines] (-2,-2) grid (2,2);
		\node (picture) at (0,0) {\includegraphics{figures/part_2_chapter_2/support_convex.pdf}};
		\node (S) at (0.25,-0.5) {$S$};
		\node (S) at (-1,1.6) {$p$};
