...
\begin{flalign*}
	...
	\st 	  & p_t + s_{t-1} = D_t + k_t, \ \forall t \in T \\
...
\subsection*{Exercise 1.1: Introduction to JuMP - part I}
\input{part_1/chapter_1/exercises/E11-jump1}

\subsection*{Exercise 1.2: Introduction to JuMP - part II}
\input{part_1/chapter_1/exercises/E12-jump2}

\subsection*{Exercise 1.3: Transportation problem}
\input{part_1/chapter_1/exercises/E13-transp1}

\subsection*{Exercise 1.4: Capacitated transportation}
\input{part_1/chapter_1/exercises/E14-transp2}

\subsection*{Exercise 1.5: The farmer's problem}
\input{part_1/chapter_1/exercises/E15-farmer}

\subsection*{Exercise 1.6: Factory planning}
\input{part_1/chapter_1/exercises/E16-factoryplanning}
