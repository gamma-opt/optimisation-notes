...
\end{equation*}
%
which, in turn, yield an upper bound for $x_j$. Clearly, the procedure can be analogously adapted to obtain a lower bound as well. Furthermore, rounding can be employed in the presence of integer variables. 
