...
% TODO: Chp10: Add a reference to the proof in the big Nemhauser and Wolsey book.
...
Like was the case in Benders decomposition, the motivation for employing cutting-plane algorithms lies in the belief that only a few of all $|\mathcal{F}|$ inequalities (assuming $\mathcal{F}$ is finite, which might not be necessarily the case) are necessary, circumventing the computationally prohibitive need of generating all possible inequalities from $\mathcal{F}$.
...
\input{part_1/chapter_10/exercises/E101-C-G_Procedure}

\subsection*{Exercise 10.2: Chv\'atal-Gomory (C-G) procedure example}
\input{part_1/chapter_10/exercises/E102-C-G_Example}

\subsection*{Exercise 10.3: Cuts from the simplex tableau}
\input{part_1/chapter_10/exercises/E103-Gomory}

\subsection*{Exercise 10.4: More Gomory cuts}
\input{part_1/chapter_10/exercises/E104-Gomory2}

\subsection*{Exercise 10.5. The cover separation problem}
\input{part_1/chapter_10/exercises/E105-Cover_sep}
