...
\begin{figure}
	\begin{tikzpicture}
		\node (pic) at (0,0) {\includegraphics{part_1/chapter_12/figures/Figure2.pdf}};
...
\begin{figure}[h]
	\begin{tikzpicture}
		\node (pic) at (0,0) {\includegraphics{part_1/chapter_12/figures/Figure3.pdf}};
...
\begin{figure}[h]
	\begin{tikzpicture}
		\node (pic) at (0,0) {\includegraphics{part_1/chapter_12/figures/Figure4.pdf}};
...
\input{part_1/chapter_12/exercises/E71-DW}
...
\input{part_1/chapter_12/exercises/E72-parametric}

\subsection*{Exercise 12.3: Benders decomposition}
\input{part_1/chapter_12/exercises/E73-Benders}
